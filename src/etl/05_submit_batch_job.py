...
def main():
    ...
    parser.add_argument("--input-jsonl", required=True, help="Путь к подготовленному .jsonl файлу.")
    ...
    parser.add_argument("--save-id-to", default=None, help="Опциональный путь к JSON файлу для сохранения Batch ID и метаданных.")
